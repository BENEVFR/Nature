...
Vous venez de terminer les différentes étapes de préparation des données.

La suite :

Vous pouvez regrouper des hex pour créer des zones :

```{r}
rstudioapi::navigateToFile(
  file = "city_hex_group_preparation.qmd",
  line = 1
)
```

ou vous pouvez également retourner sur la vignette pour la suite des préparations. 
